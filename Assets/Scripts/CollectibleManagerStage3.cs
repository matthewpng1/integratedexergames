...
public class CollectibleManagerStage3 : MonoBehaviour
{
    public static CollectibleManagerStage3 instance; // Singleton instance
    ...
    public int totalCollectibles = 11; // Set this based on the total collectibles in your level
